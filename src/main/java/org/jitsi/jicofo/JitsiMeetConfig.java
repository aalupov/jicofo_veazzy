...
public class JitsiMeetConfig {
    ...
    /**
     * The name of the property which enables the inclusion of the REMB RTCP in
     * the offer.
     */
     ...
     * used instead of any bridges elected by <tt>BridgeSelector</tt>. The
     * property is meant to be used in a test that aims to run a conference on
     * specific bridge instance. That property is per conference specific.
     */
     ...
     * <tt>BridgeSelector</tt>. <tt>null</tt> if not specified. That property is
     * per conference specific.
     */
