...
public class JvbDoctor
    ...
    /**
     * Capabilities operation set used to detect health check support on the
     * bridge.
     */
    ...
    private class HealthCheckTask implements Runnable {
        ...
        /**
         * Indicates whether or not the bridge has health-check support. If set
         * to <tt>null</tt> it means that we don't know that yet (there was no
         * successful disco-info exchange so far).
         */
         ...
         *
         * @throws OperationFailedException when XMPP got disconnected - the
