...
public class AuthenticationSession {
    ...
    /**
     * User's jabber ID recently used with this session. Used to bind anonymous
     * JID to {@link #userIdentity}.
     */
     ...
     * distinguish between session for the same user on different machines.
