...
public interface AuthenticationAuthority {
     ...
     * <room_name}@{muc_address}. @param popup <tt>t r ue</tt> if this URL will
     * be opened in the popup (used for live authentication once the conference
     * has been started).
     *
     ...
     * authenticated.
     * @param response the <tt>ConferenceIq</tt> response that will be returned
     * to the user. Implementing classes can fill some information in order to
     ...
     *
     * @param iq the <tt>LogoutIq</tt> that described authentication session to
     * be destroyed.
     *
