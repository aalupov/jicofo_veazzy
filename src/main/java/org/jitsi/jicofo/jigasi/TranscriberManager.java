...
public class TranscriberManager
    ...
    /**
     * The {@link JigasiDetector} responsible for determining which Jigasi to
     * dial to when inviting the transcriber.
     */
    ...
    /**
     * Returns a list of regions of the bridges that are currently used in the
     * conference, empty list if nothing found or an error occurs.
     *
