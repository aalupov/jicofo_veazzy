...
public class JigasiDetector
     ...
     * which all Jigasi instances. Can be just roomName, then the muc service
     * will be discovered from server and in case of multiple will use the first
     * one. Or it can be full room id: roomName@muc-servicename.jabserver.com.
     */
    ...
    /**
     * Checks whether the {@code BrewInstance} is a legacy instance. A legacy
     * instance is the one that has stats and both support sip and transcription
     * stats are not set (are null).
     *
     * @param bi the {@code BrewInstance} to check.
