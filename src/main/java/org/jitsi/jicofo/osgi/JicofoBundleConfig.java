    ...
    protected String[][] getBundlesImpl() {
        ...
        String[][] bundles = {
            ...
            },
            {
                ...
                "org/jitsi/eventadmin/Activator", //"net/java/sip/communicator/impl/fileaccess/FileAccessActivator"
            },
            {
            ...
            : new String[]{ //"net/java/sip/communicator/impl/neomedia/NeomediaActivator"
            },
