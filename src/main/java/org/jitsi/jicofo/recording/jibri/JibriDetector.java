...
public class JibriDetector
     ...
     * which all Jibri instances report their availability status. Can be just
     * roomName, then the muc service will be discovered from server and in case
     * of multiple will use the first one. Or it can be full room id:
    ...
    /**
     * The name of config property which provides the name of the MUC room in
     * which all SIP Jibri instances report their availability status. Can be
     * just roomName, then the muc service will be discovered from server and in
     * case of multiple will use the first one. Or it can be full room id:
     * roomName@muc-servicename.jabserver.com.
     */
