...
public class Conference {
     ...
     * room_name@muc.server.net. Short room name is extracted and stored in
     * {@link #name} field.
    ...
    /**
     * Returns full XMPP MUC room address that hosts the conference, in the form
     * of room_name@muc.server.net.
     */
     ...
     * #DATE_FORMAT} and stores it in output JSON object map fi given value is
     * not null.
     *
    ...
    /**
     * Stores given <tt>String</tt> in output JSON object map if it's value is
     * not <tt>null</tt> nor empty.
     *
     * @param map output JSON Object map.
