...
public class MediaSourceMap {
     ...
     *
     * CopyOnWriteArrayList "never changes during the lifetime of the iterator,
     * so interference is impossible and the iterator is guaranteed not to throw
    ...
    /**
     * Creates new instance of <tt>MediaSourceMap</tt> initialized with given
     * map of media sources.
     *
    ...
    /**
     * Adds sources to this map. NOTE that duplicates will NOT be stored in the
     * map.
     *
     * @param mediaType the media type of sources to be added to this map.
     *
     * @param newSources collection of sources which will be included in this
     * map.
     */
     ...
     *
     * @return a new instance of <tt>MediaSourceMap</tt> which contains copies
     * of
     ...
     *
     * @return <tt>SourcePacketExtension</tt> found in this map which has the
     * same SSRC number as given in the <tt>ssrcValue</tt> or
