...
public class MediaSourceGroupMap {
     ...
     * @param sourceGroup <tt>SourceGroup</tt> that will be mapped to given
     * media type.
     */
    ...
    /**
     * Adds source groups contained in given <tt>MediaSourceGroupMap</tt> to
     * this map instance.
     *
     * @param sourceGroups the <tt>MediaSourceGroupMap</tt> that will be added
     * to this map instance.
     */
     ...
     * <tt>SourceGroupPacketExtension</tt> which reflects current state of this
     * <tt>MediaSourceGroupMap</tt>.
     */
