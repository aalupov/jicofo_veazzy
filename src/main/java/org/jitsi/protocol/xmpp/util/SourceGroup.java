...
public class SourceGroup {
     ...
     *
     * @param group the packet extension that described source group to be
     * wrapped by new object.
     ...
     *
     * NOTE it makes sense only once the attributes have been copied from the
     * media section {@link SourcePacketExtension}s, as normally
     ...
     * considered equal if: 1. They have the same semantics 2. They have the
     * same sources (according to {@link SourcePacketExtension#equals(Object)}),
